...
由于本站使用的是**定制节点**，处于**测试阶段**，所以您可能会在访问本站的过程中遇到 SSL 窜站的问题（SSL 证书域名是“*.edgenext.com”、“tictokcdn.com”，抑或是本站域名的过期证书），这系正常现象。您可以按照以下步骤临时解决：

- 刷新页面
- 切换英文输入法，在浏览器（Chromium 内核）的警告页面依次按下“thisisunsafe”，随即浏览器便会显示本站主页。
- 抑或是尝试使用无痕模式加载本网页，SSL 证书大概率会恢复正常。
